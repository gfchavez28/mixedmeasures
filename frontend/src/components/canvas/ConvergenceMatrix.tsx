...
const REL_COLORS: Record<string, string> = {
  ...
  // eslint-disable-next-line no-restricted-syntax -- categorical relationship-type color map hue (the internal design notes carve-out; siblings raw, not the mm-blue "selected" token)
    ...
    <div data-convergence-matrix className="absolute top-14 right-4 w-[440px] z-[60] bg-white dark:bg-mm-surface border border-mm-border rounded-lg shadow-xl">
      ...
      <div className="px-4 pb-4 overflow-auto max-h-[400px]">
        <table role="table" className="border-collapse text-[10px] w-full">
          <caption className="sr-only">Convergence matrix: how each theme relates to every other theme.</caption>
          <thead>
            <tr>
