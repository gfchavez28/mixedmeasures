...
const TAG_COLORS: Record<string, string> = {
  ...
  // eslint-disable-next-line no-restricted-syntax -- categorical tag-color map hue (the internal design notes carve-out; siblings raw, not the mm-blue "selected" token)
...
const TAG_DOT_COLORS: Record<string, string> = {
  ...
  // eslint-disable-next-line no-restricted-syntax -- categorical tag-dot color map hue (the internal design notes carve-out)
